...
function quoteChange() {
    var randnum = Math.random();
        ...
        var quotes = new Array("Left index finger chopped off with butcher's knife at the age of 14 in failed attempt to make acorn squash soup.", "During marathon season, only has a set of eight complete toenails.","No Asian Glow!", "Consumed three total Starbucks drinks: Java Chip, Java Chip, Java Chip. Tall.", "One Market Pantry jar of Natural Peanut Butter per six days.", "Sweat machine.", "Gym ratty.", "Spontaneous violin jam session with two street artists in Florence.", "Guess how to pronounce it. Q-I-A-N.", "Purple cabbage makes Blue Dumplings. A Venetian Classic.", "Olivia says Qian spent twelve dollars this fiscal year. False.", "Cracked robin eggs as a profession in Kindergarten.", "Oreos assisted in journey through Anna Karenina.", "True Story, Potential Headline: Alone in Paris for Six Days, All Meals Made from Supermarket Food.", "Sprained ankle in the rain, presented torturously rank feet to nurse for wrapping.", "Counts in Korean to work out, nothing else. Doesn't know Korean at all.", "Enjoyed lying on top of cars in motion until a Good Samaritan told us to get off before she called the Cops.");
